...
public class ListStateOperator extends AbstractStreamOperator<Tuple2<MyKey, MyValue>>
    ...
    private ListStateDescriptor<MyValue> listStateDescriptor;
    private ListState<MyValue> listState;
    ...
    public void open() throws Exception {
        ...
        this.listStateDescriptor = new ListStateDescriptor<>("state", MyValue.class);
        ...
        getKeyedStateBackend()
                .applyToAllKeys(
                        ...
                        (key, value) -> {
                            ...
                            value.get().forEach(v -> values.add(v.getValue()));

                            output.collect(
                                    STATE_RESULT_TAG,
                                    new StreamRecord<>(
                                            key + " " + StringUtils.join(values, " ")));
                        });
    }
